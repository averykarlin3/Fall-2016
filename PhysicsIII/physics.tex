...
\2 As a result, it is found that $\psi(x, t) = \psi(x - \delta x, t - \delta t)$, and $\delta x = v \delta t$, such that some value, $\psi_0$ moves at v
\3 Thus, $\psi(x_0, 0) = \psi(x_0 + vt, t) = \psi(u)$
...
\2 This is then used to determine the overall wave equation
\end{outline*}
\end{document}
