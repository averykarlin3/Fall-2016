...
\4 Since that is within the frame of reference of the clocks, it is multiplied by the Lorentz factor, such that when the clock moving from the light waves is at t = 0, the other is at $t = \frac{vD}{c}$, giving the time lag factor for clocks in the same frame
