...
\1 Momentum must be defined as a four-vector, denoted $(p_{\mu}) = m(v_{\mu})$, where the four-vector velocity, $v_{\mu} = \frac{dx_\mu}{d\tau}$, where $\tau$ is the proper time, such that it is a four-scalar rather than a four-vector
\2 
\end{outline*}
