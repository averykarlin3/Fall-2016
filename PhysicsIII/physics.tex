...
\4 It is generally a positive number, though there are exceptions such as water for $0-4^o C$ melting point, and is generally a function of P and T
\4 It often varies negligibly with respect to P and very little with respect to T often within a small temperature range, such that it can be considered a constant over the range
...
\4 Isothermal compressibility, or the reciprocal of isothermal bulk modulus, $\kappa = \frac{-1}{V}(\frac{\partial V}{\partial P})$, and is similarly often constant for a material over some range
