...
\2 For some complex wavefunction, $\psi(x, t) = acos(kx - \omega t) + iasin(kx - \omega t) = ae^{i(kx - \omega t)}$, such that it is a travelling wave where $u = k(x - v_pt)$
...
\2 The path is defined as the ray path, either of a narrow beam from a slit blocking the light wave, or of the normal to the wavefront
