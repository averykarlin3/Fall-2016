...
\2 The primary rainbow has one reflection and two refractions, while the secondary rainbow has two reflections and two refractions, with larger angle for each wavelength
...
\3 $d_1$ is the distance from the ray origin on the axis to the point of refraction $d_2$ is the distance from when the diffracted ray hits the axis, and R is the radius
...
\2 Two spheres of different curvatures/radii are often combined to send the image into the original medium on the opposite side, called a lens
\1 
\end{outline*}
\section{Notes}
