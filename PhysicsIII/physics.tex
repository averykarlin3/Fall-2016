...
\3 These display dispersion as a result, changing the shape during propagation, rather than being a travelling wave, such that phase velocity and angular frequency are dependent on wave number
...
\2 It can be then found geometrically that the wavefronts are at equal angles to the surface of the mirror, creating the Law of Reflection
...
\1 The relationship between the angles and velocity are embodied by Snell's law of refraction, commonly written in terms of a refractive index, $\eta$ of the medium, such that $\eta = \frac{c}{v_p}$, such that if $\theta$ is the angle from the normal line, $\eta_1 sin(\theta_1) = \eta_2 sin(\theta_2)$
...
\begin{outline*}
\1 Geometric optics are the movement of a ray/wavefront moving in a straight line, and the effects of a change in medium
\end{outline*}
\section{Notes}
