...
\3 In LC-3, labels can be placed on assembler commands, setting that label as the current location within the assembler, while this cannot be done in LC-4
\3 Labels are often used to designate the start of loops or functions, as well as the end of the program overall in LC-4
\2 Immediate values are written non-symbolically, such that binary is prefaced by a b, hex by an x, and decimal by an \#
