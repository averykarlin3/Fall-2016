...
\begin{outline*}
\1 Pointers in C are defined as the address of a memory object, indirectly accessing them, while arrays are sequential lists of data, also indirectly accessed
