...
\1 The memory for a standard computer in modern day is $2^{28}$ by 8 bits, while the LC-3 has $2^{12}$ by 16 bits
...
\2 It also contains the address of the next instruction, stored within the program counter (PC)
\end{outline*}
\end{document}
