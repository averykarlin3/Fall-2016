...
\2 The timer measures the time in milliseconds, written in the Timer Interval Register (TIR) at xFE0A similarly
...
\3 Within the LC-4, this is done by moving into supervisor mode, which is able to execute non-user data
